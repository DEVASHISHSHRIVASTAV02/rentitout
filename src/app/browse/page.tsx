  ...
  return (
    <div className="mx-auto w-full max-w-screen-2xl min-w-0 space-y-5 px-4 py-6 sm:space-y-6 sm:px-6 sm:py-12">
      ...
      <section className="grid min-w-0 gap-4 lg:grid-cols-4 lg:items-start">
        <details className="group min-w-0 overflow-hidden rounded-2xl border border-zinc-200 bg-white lg:hidden">
        ...
        <aside className="hidden min-w-0 rounded-2xl border border-zinc-200 bg-white p-4 sm:p-5 lg:sticky lg:top-24 lg:block">
          <BrowseFiltersForm
